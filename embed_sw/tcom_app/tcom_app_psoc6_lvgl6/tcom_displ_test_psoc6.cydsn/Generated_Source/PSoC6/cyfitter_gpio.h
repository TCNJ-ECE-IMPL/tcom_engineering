...
/* USER_LED_GRN */
#define USER_LED_GRN_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define USER_LED_GRN_0_INBUF_ENABLED 0u
#define USER_LED_GRN_0_INIT_DRIVESTATE 0u
#define USER_LED_GRN_0_INIT_MUXSEL 0u
#define USER_LED_GRN_0_INPUT_SYNC 2u
#define USER_LED_GRN_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define USER_LED_GRN_0_NUM 1u
#define USER_LED_GRN_0_PORT GPIO_PRT7
#define USER_LED_GRN_0_SLEWRATE CY_GPIO_SLEW_FAST
#define USER_LED_GRN_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define USER_LED_GRN_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define USER_LED_GRN_INBUF_ENABLED 0u
#define USER_LED_GRN_INIT_DRIVESTATE 0u
#define USER_LED_GRN_INIT_MUXSEL 0u
#define USER_LED_GRN_INPUT_SYNC 2u
#define USER_LED_GRN_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define USER_LED_GRN_NUM 1u
#define USER_LED_GRN_PORT GPIO_PRT7
#define USER_LED_GRN_SLEWRATE CY_GPIO_SLEW_FAST
#define USER_LED_GRN_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS

/* USER_LED_RED */
#define USER_LED_RED_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define USER_LED_RED_0_INBUF_ENABLED 0u
#define USER_LED_RED_0_INIT_DRIVESTATE 0u
#define USER_LED_RED_0_INIT_MUXSEL 0u
#define USER_LED_RED_0_INPUT_SYNC 2u
#define USER_LED_RED_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define USER_LED_RED_0_NUM 3u
#define USER_LED_RED_0_PORT GPIO_PRT6
#define USER_LED_RED_0_SLEWRATE CY_GPIO_SLEW_FAST
#define USER_LED_RED_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define USER_LED_RED_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define USER_LED_RED_INBUF_ENABLED 0u
#define USER_LED_RED_INIT_DRIVESTATE 0u
#define USER_LED_RED_INIT_MUXSEL 0u
#define USER_LED_RED_INPUT_SYNC 2u
#define USER_LED_RED_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define USER_LED_RED_NUM 3u
#define USER_LED_RED_PORT GPIO_PRT6
#define USER_LED_RED_SLEWRATE CY_GPIO_SLEW_FAST
#define USER_LED_RED_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
